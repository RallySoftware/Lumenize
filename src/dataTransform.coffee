define 'dataTransform', [
  ...
  exports=
    arrayOfMaps_To_CSVStyleArray: arrayOfMaps_To_CSVStyleArray
    csvStyleArray_To_ArrayOfMaps: csvStyleArray_To_ArrayOfMaps
    arrayOfMaps_To_HighChartsSeries: arrayOfMaps_To_HighChartsSeries
    csvString_To_CSVStyleArray: csvString_To_CSVStyleArray
    csvStyleArray_To_CSVString: csvStyleArray_To_CSVString
